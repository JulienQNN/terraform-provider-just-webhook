...
resource "jwb_webhook_slack_message" "simple_with_image_and_link" {
  webhook_url = "https://webhook.site/c5648699-9649-4018-b07a-aa4343a52b14"
  blocks = [
    {
      type = "section"
      text = {
    ...
    },
    {
      ...
      text = {
        ...
        text = "<https://google.com|Google is your friend, maybee>"
					...
					resource.TestCheckResourceAttr("jwb_webhook_slack_message.simple_with_image_and_link", "webhook_url", "https://webhook.site/c5648699-9649-4018-b07a-aa4343a52b14"),
